...
?>
  ...
  $descripcion=$row['descripcion'];
	...
	$sql_repu= mysqli_query($conec,"SELECT * FROM repuestos WHERE id_repuestos='$id_re' AND no_parte='$id_partes' AND part_order='$po'");
  		...
  		<section id="container">
                  ...
                  <input type="hidden" name="id_partes" value="<?php echo $id_partes ?>">
  								...
  								<label for="tecnicos">Descripción:</label>
									...
									<label for="serial_guia">Guía Devolución:</label>
