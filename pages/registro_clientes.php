...
<head>
	...
	<title>Registro Clientes - Soporte S.A</title>
...
<body>
	<?php include ("url/header.php"); ?>
		<section id="container">
				...
				<form name="tecnicos" method="POST" action= "php/registro_clientes.php" id="tecnicos">

						<h1 align="center">Registro Clientes </h1><br>
												...
												<input type="text" name="nombre_cliente" size="50" maxlength="50" required >
												<label for="tecnicos">Contacto:</label>
											<input type="text" name="contacto" size="20" maxlength="20" required >
											<label for="tecnicos"> Ciudad:</label>
											<select name="ciudad" class="ciudad" required>
																				...
																				<option value="Puerto Nariño">Puerto Nariño
																				<option value="Puerto Santander">Puerto Santander
																				<option value="Tarapaca">Tarapaca
																				<option value="Inirida">Inirida
																				<option value="Barranco Minas">Barranco Minas
																				<option value="Mapiripana">Mapiripana
																				<option value="San Felipe">San Felipe
																				<option value="Puerto Colombia">Puerto Colombia
																				<option value="La Guadalupe">La Guadalupe
																				<option value="Cacahual">Cacahual
																				<option value="Pana Pana">Pana Pana
																				<option value="Morichal">Morichal
																				<option value="San José Del Guaviare">San José Del Guaviare
																				<option value="Calamar">Calamar
																				<option value="El Retorno">El Retorno
																				<option value="Miraflores">Miraflores
																				<option value="Mitú">Mitú
																				<option value="Caruru">Caruru
																				<option value="Pacoa">Pacoa
																				<option value="Taraira">Taraira
																				<option value="Papunaua">Papunaua
																				<option value="Yavarate">Yavarate
																				<option value="Puerto Carreño">Puerto Carreño
																				<option value="La Primavera">La Primavera
																				<option value="Santa Rosalia">Santa Rosalia
																				<option value="Cumaribo">Cumaribo
																				</select>
								<label for="tecnicos"> Direccion:</label>
								<input type="text" name="direccion" size="50" maxlength="50" required >
								<label for="tecnicos"> Telefono:</label>
							<input type="text" name="telefono" size="20" maxlength="20" required >
							<label for="tecnicos"> Movil:</label>
							<input type="text" name="movil" size="20" maxlength="20" required >
								<label for="tecnicos"> Correo electrónico:</label>
								<input type="email" name="email" size="80" maxlength="80" required >
						...
						<input id="cierre" type="button" onclick=" location.href='ver_clientes.php'" value="Ver Clientes"  />
