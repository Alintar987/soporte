...
<body>
	<?php include ("url/header.php"); ?>
		<section id="container">
				...
				<form name="tecnicos" method="POST" action= "excel/orden_servicio.php" id="tecnicos">

						<h1 align="center">Repuestos para Ruta</h1><br>
						<label for="tecnicos">Part order:</label>
						<select class="parte" name="part_order[]" multiple="multiple" required>
